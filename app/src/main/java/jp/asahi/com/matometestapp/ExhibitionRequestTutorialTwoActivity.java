...
public class ExhibitionRequestTutorialTwoActivity extends AppCompatActivity implements TabClick {
    ...
    public void onClick(View v) {
        Intent intent = null;
        switch (v.getId()) {
            case R.id.exhibition_request_tutorial_two_activity_cross:
                intent = new Intent(this, DeliveryKitRequestActivity.class);
                break;
            case R.id.exhibition_request_tutorial_two_activity_button:
                intent = new Intent(this, ExhibitionRequestTutorialThreeActivity.class);
                break;
        }
